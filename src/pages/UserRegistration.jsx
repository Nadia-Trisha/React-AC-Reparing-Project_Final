...
export default function UserRegistration() {
   ...
   const submitHandler = (e) => {
    ...
    if (formData.password !== formData.confirmpassword) {
        ...
        axios.post("http://localhost:5173/registration").then(
            (res) => {
         ...
         <div className="container-fluid py-5">
            <div className="container py-5">
                <div className="text-center mb-5 wow fadeInUp" data-wow-delay=".3s">
                    ...
                    <h1 className="display-5 w-50 mx-auto">User Registration</h1>
                </div>
                <div className="row g-5 mb-5">
                    ...
                    <div className="col-lg-12 wow fadeInUp" data-wow-delay=".5s">
                        ...
                        <div className="rounded contact-form">
                            ...
                            <div className="mb-4">
                                <input type="number" className="form-control p-3" name='password' onChange={changeHandler} placeholder="Password"/>
                            </div>
                            {/* <div className="mb-4">
                                <textarea className="w-100 form-control p-3" rows="6" cols="10"  name='massege' onChange={changeHandler} placeholder="Message"></textarea>
                            </div> */}
