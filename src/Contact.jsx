...
const contact = ()=>{
  axios.post("http://localhost/ac_servicing/Api/userInsert.php", {data:userInfo}).then(res=>{
      alert(res.data.msg);
        ...
        <div className="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
          ...
          <form onSubmit={handleSubmit}>
            <div className="row g-3">
              ...
              <div className="col-12">
                <input className="btn btn-primary py-3 px-5" type="submit"  name='submit' value="submit" />
